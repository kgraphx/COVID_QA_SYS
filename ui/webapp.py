...
DEFAULT_QUESTION_AT_STARTUP = "What is known about transmission, incubation, and environmental stability?"
...
def main():
    ...
    st.write("# Covid19 Extractive Q&A System, Just for Learning not Consulting ")
